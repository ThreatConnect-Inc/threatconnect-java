...
public class StixWriter
{
	...
	private org.mitre.stix.indicator_2.Indicator toStixIndicator(final Indicator indicator,
		final boolean includeWeblink)
	...
	private Observable toObservable(final Indicator indicator) throws UnsupportedIndicatorTypeException
	{
		ObjectType obj;
	...
	private ObjectType buildAddressObject(final Address address)
	{
	...
	private ObjectType buildEmailAddressObject(final EmailAddress emailAddress)
	{
	...
	private ObjectType buildFileObject(final File file)
	{
	...
	private ObjectType buildDomainObject(final Host host)
	{
	...
	private ObjectType buildUriObject(final Url url)
	{
	...
	private List<HashType> createFileHashTypes(final File file)
	{
