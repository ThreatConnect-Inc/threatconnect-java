...
public class AppUtil {
	...
	public String getTcProxyHost() {
		return p(TC_PROXY_HOST);
	}

	public String getTcProxyPort() {
		return p(TC_PROXY_PORT);
	}

	public String getTcProxyUsername() {
		return p(TC_PROXY_USERNAME);
	}

	public String getTcProxyPassword() {
		return p(TC_PROXY_PASSWORD);
	}
	...
	public static void configureLogger(String logFilename, Level level) throws IOException {
		...
		/*
		 * Logger rootLogger = Logger.getLogger(""); Handler[] handlers =
