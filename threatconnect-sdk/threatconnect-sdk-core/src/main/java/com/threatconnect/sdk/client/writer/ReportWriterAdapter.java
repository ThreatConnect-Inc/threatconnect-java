...
import com.threatconnect.sdk.server.response.entity.ReportResponse;
 ...
 */
public class ReportWriterAdapter extends AbstractGroupWriterAdapter<Report>
{
	protected ReportWriterAdapter(Connection conn)
	{
		super(conn, ReportResponse.class);
	}
		...
		UploadMethodType uploadMethodType, Boolean updateIfExists) throws IOException, FailedResponseException
	{
		...
		return uploadFile("v2.reports.upload", ReportResponse.class, ownerName, new FileInputStream(file), paramMap,
